...
def build_areas_w_victims(builder, victims_per_area, areas):
    ...
    for area_name, area_data in areas.items():
        ...
        for v2 in range(victims_per_area):
            ...
            builder.add_object(location=(loc_victim_x[v2],loc_victim_y[v2]),name="victim_"+str(victim)+"_", callable_class=CollectableBlock, visualize_shape='img',img_name="/images/victims/v"+str(victim)+".png")
